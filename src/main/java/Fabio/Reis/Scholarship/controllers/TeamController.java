...
public class TeamController {
    ...
    @GetMapping
    public ResponseEntity<List<TeamDTO>> getAllClasses() {
    ...
    public ResponseEntity<List<InternalDTO>> getClassInstructors(@PathVariable Long id) {
        return teamService.getClassInstructors(id);
    }

    @GetMapping("/{id}/scrum-masters")
    public ResponseEntity<List<InternalDTO>> getScrumMasters(@PathVariable Long id) {
        return teamService.getScrumMasters(id);
    }

    @GetMapping("/{id}/coordinators")
    public ResponseEntity<List<InternalDTO>> getCoordinators(@PathVariable Long id) {
    ...
    @PutMapping("/{id}")
    public ResponseEntity<Void> updateClass(@PathVariable Long id, @RequestBody TeamRequestDTO teamRequest) {
